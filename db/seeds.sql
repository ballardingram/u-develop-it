...
VALUES
  ...
  ('Derek','Jarman','djarman@propectcottage.net'),
  ...
  ('Rhoda','Broughton','rb@feminist.net'),
  ...
  ('Anthony','Trollope','atrolope@barchester.com'),
  ('Charlette','Yonge','cyonge@newday.com'),
  ...
  ('William','Carlton','wcarleton@literaure.com'),
